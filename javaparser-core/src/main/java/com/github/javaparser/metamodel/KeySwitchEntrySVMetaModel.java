...
public class KeySwitchEntrySVMetaModel extends SwitchEntryMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    KeySwitchEntrySVMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(
                superBaseNodeMetaModel,
                KeySwitchEntrySV.class,
                "KeySwitchEntrySV",
    ...
    public PropertyMetaModel schemaVarPropertyMetaModel;
