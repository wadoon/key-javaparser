...
<dependency>
    ...
    <version>3.28.0-K12.3-SNAPSHOT</version>
</dependency>
```
...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.28.0-K12.3-SNAPSHOT'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.28.0-K12.3-SNAPSHOT'
```
